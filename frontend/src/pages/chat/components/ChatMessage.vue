...
import { BookOpen, RefreshCw, ThumbsDown, ThumbsUp, UserRound } from 'lucide-vue-next'
  ...
  <article class="chat-message" :class="message.role">
    ...
    <div class="chat-message-content">
      ...
      <p v-else-if="stateLabel(message)" class="chat-message-state" :class="message.state">
        <span v-if="message.state === 'generating' || message.state === 'pending'" class="loading-spinner" />
        {{ stateLabel(message) }}
      </p>
