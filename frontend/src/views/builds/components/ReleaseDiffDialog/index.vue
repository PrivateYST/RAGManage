...
import { AppDialog, CheckCircle2, GitCompareArrows, Rocket, TriangleAlert, X } from '@/components'
...
<template>
  <AppDialog
    ...
    @close="handleClose"
  >
    <section class="release-diff-dialog">
      ...
      <div v-else-if="preview" class="release-diff-body">
        ...
        <section class="release-config-compare">
          ...
          <div class="release-config-grid">
            ...
            <span>网关端点</span><strong>{{ preview.build.base_url }}</strong> <span>嵌入模型</span
